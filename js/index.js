...
var AutoScalingText = function (_React$Component) {
  ...
  function AutoScalingText() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AutoScalingText.__proto__ || Object.getPrototypeOf(AutoScalingText)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      scale: 1
  ...
  _createClass(CalculatorKey, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          props = _objectWithoutProperties(_props2, ["onPress", "className"]);
...
var Calculator = function (_React$Component4) {
  ...
  function Calculator() {
    ...
    return _ret2 = (_temp2 = (_this5 = _possibleConstructorReturn(this, (_ref2 = Calculator.__proto__ || Object.getPrototypeOf(Calculator)).call.apply(_ref2, [this].concat(args))), _this5), _this5.state = {
      value: null,
      displayValue: '0',
      operator: null,
